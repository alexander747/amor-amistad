...
import NeonCorazon from '@/components/templates/neon-corazon/NeonCorazon'
import { getBrandName } from '@/lib/env'
import type { PageData } from '@/lib/types'

/**
 * Static, safe demo for the neon-corazon template. Fictional data, no database
 * and no R2. Always `noindex`: it is a showcase, not a customer page.
 */
export const metadata: Metadata = {
  title: { absolute: `Demo Neon Corazón · ${getBrandName()}` },
...
export default function DemoNeonPage() {
  return <NeonCorazon data={DEMO_DATA} />
}
