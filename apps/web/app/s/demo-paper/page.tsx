...
import PaperLuxe from '@/components/templates/paper-luxe/PaperLuxe'
import { getBrandName } from '@/lib/env'
import type { PageData } from '@/lib/types'

/**
 * Static, safe demo for the paper-luxe template. Fictional data, no database
 * and no R2. Always `noindex`: it is a showcase, not a customer page.
 */
export const metadata: Metadata = {
  title: { absolute: `Demo Paper Luxe · ${getBrandName()}` },
...
export default function DemoPaperPage() {
  return <PaperLuxe data={DEMO_DATA} />
}
